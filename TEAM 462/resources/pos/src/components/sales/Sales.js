...
const Sales = (props) => {
    ...
    const onShowPaymentClick = (item) => {
        console.log('Show payment clicked:', item);
    ...
    const onCreatePaymentClick = (item) => {
        console.log('Create payment clicked:', item);
        if (item) {
            setCreatePaymentItem(item);
    ...
    const itemsValue =
        ...
        sales.length >= 0 &&
        sales.map((sale) => {
            console.log('Sale data:', sale.attributes);
            return {
    ...
    return (
        <MasterLayout>
            ...
            <CreatePaymentModal
                ...
                onCreatePaymentClick={handleClosePaymentModal}
