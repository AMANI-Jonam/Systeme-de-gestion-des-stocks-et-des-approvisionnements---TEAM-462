...
const Settings = (props) => {
            ...
            setSettingValue({
                ...
                date_format:
                    ...
                    defaultDate
                        ...
                        : "",
                Currency_icon_Right_side:
                    settings.attributes && settings.attributes.is_currency_right === "1"
                        ? "1"
                        : "0",
            });
            if (
    ...
    const handleChangedCurrency = (event) => {
        ...
        setSettingValue((settingValue) => ({
            ...settingValue,
            Currency_icon_Right_side: checked ? "1" : "0",
        }));
    };
                    ...
                    <div className="card-body">
                        <Form>
                            <div className="row">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <div className="d-flex align-items-center mt-2">
                                            <label className="form-check form-switch form-switch-sm">
                                                <input
                                                    type="checkbox"
                                                    checked={settingValue.Currency_icon_Right_side === "1"}
                                                    name="Currency_icon_Right_side"
                                                    onChange={event => {
                                                        setDisable(false);
                                                        setSettingValue(prev => ({
                                                            ...prev,
                                                            Currency_icon_Right_side: event.target.checked ? "1" : "0"
                                                        }));
                                                    }}
                                ...
                                {/* Masquer complètement le champ bas de page (footer) */}
                                {/*<div className="col-lg-6 mb-3">
                                    <label className="form-label">
                                        {getFormattedMessage(
                                ...
                                {/* Masquer les champs SMTP (paramètres de messagerie) */}
                                {/*<div className="col-lg-6 mb-3">
                                    <div className="col-md-6">
                                        <label className="form-label">
                                ...
                                <div className="col-lg-6 mb-3">
                                    <div className="col-md-6">
                                        ...
                                        <input type='text' className="form-control"
                                               placeholder={placeholderText("settings.smtp-configuration.input.port.label")}
                                               name='smtp_port'
